        ...
        <div className="flex flex-col space-y-6 md:flex-row md:justify-between md:items-start md:space-y-0 md:gap-8 lg:gap-16 xl:gap-24">
          ...
          <div className="text-sm text-gray-600">
            <p className="text-center md:text-left">
              ...
              the Inter typeface, ensuring clarity and readability across all
              devices. This portfolio is inspired by the amazing work of
              Britanny Chiang, whose design aesthetics and attention to detail
              have greatly influenced my approach to this portfolio.
            </p>
          </div>
        </div>
      </div>
